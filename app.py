...
@app.route("/logarith", methods=["POST", "GET"])
def logarith():
    if request.method == "POST":
        try:
            image = request.files["image"]
...
@app.route("/gamma", methods=["POST", "GET"])
def gamma():
    if request.method == "POST":
        try:
            image = request.files["image"]
...
@app.route("/weighted_average", methods=["POST", "GET"])
...
@app.route("/knn_average", methods=["POST", "GET"])
def knn_average():
    if request.method == "POST":
        try:
            image = request.files["image"]
...
@app.route("/roberts", methods=["POST", "GET"])
def roberts():
    if request.method == "POST":
        try:
            image = request.files["image"]
...
@app.route("/sobel", methods=["POST", "GET"])
def sobel():
    if request.method == "POST":
        try:
            image = request.files["image"]
...
@app.route("/prewitt", methods=["POST", "GET"])
def prewitt():
    if request.method == "POST":
        try:
            image = request.files["image"]
...
@app.route("/laplacian", methods=["POST", "GET"])
def laplacian():
    if request.method == "POST":
        try:
            image = request.files["image"]
...
@app.route("/otsu", methods=["POST", "GET"])
def otsu():
    if request.method == "POST":
        try:
            image = request.files["image"]
...
@app.route("/rlc", methods=["POST", "GET"])
def rlc():
    if request.method == "POST":
        try:
            image = request.files["image"]
...
@app.route("/erosion", methods=["POST", "GET"])
def erosion():
    if request.method == "POST":
        try:
            image = request.files["image"]
...
@app.route("/dilation", methods=["POST", "GET"])
def dilation():
    if request.method == "POST":
        try:
            image = request.files["image"]
